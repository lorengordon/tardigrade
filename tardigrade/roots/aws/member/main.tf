...
module "guardduty" {
  source = "git::https://github.com/plus3it/terraform-aws-tardigrade-guardduty.git?ref=3.0.1"
...
module "securityhub" {
  source = "git::https://github.com/plus3it/terraform-aws-tardigrade-security-hub.git//modules/cross-account-member?ref=2.0.1"
